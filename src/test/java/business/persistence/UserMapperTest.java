...
public class UserMapperTest {
    ...
    private final static String DATABASE = "crypto";  // Change this to your own database
    private final static String TESTDATABASE = DATABASE + "crypto_test";
    private final static String USER = "crypto";
    private final static String PASSWORD = "crypto123";
